SEED_VALUES = [
    ...
    {"key": "fcf", "label_de": "Free Cash Flow", "label_en": "Free Cash Flow", "category": "INPUTS", "source_type": "API", "data_type": "NUMERIC", "unit": None, "sort_order": 13},
    {"key": "capex", "label_de": "Capex (= OpCF − FCF)", "label_en": "Capex (= OpCF − FCF)", "category": "INPUTS", "source_type": "CALCULATED", "data_type": "NUMERIC", "unit": None, "sort_order": 14},
